...
const texts = [
    ...
    'Only [_1] decimal points are allowed.',
...
const generate = () => {
    all_languages.forEach(lang => {
        common.print(`Generating src/javascript/_autogenerated/${lang}.js`.green);
        const js_path = path.join(common.root_path, `src/javascript/_autogenerated/${lang}.js`);
        let content = `const texts_json = {};\ntexts_json['${lang.toUpperCase()}'] = `;
