...
sub all_pages {
    return (
        ...
        ['home-beta',                  'home/index_beta',              'full_width', 'Online Trading platform for binary options on Forex, Indices, Commodities and Smart Indices', 'ja'],
        ...
        ['omnibus',                    'partners/omnibus',                   'full_width', 'Omnibus',                         'ja'],
