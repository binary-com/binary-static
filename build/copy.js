module.exports = {
    all: {
        files: [
            ...
            { expand: true, cwd: 'src/javascript/lib/hackathon/',                   src: ['**'],    dest: global.dist + '/js/hackathon/' },
            { expand: true, cwd: 'src/javascript/lib/landing/',                     src: ['**'],    dest: global.dist + '/js/landing/' },
