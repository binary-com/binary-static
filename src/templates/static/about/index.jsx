    ...
    <div className='about-us box-inlay-borders static_full'>
        ...
        <div className='container'>
            <div className='gr-parent'>
                ...
                <p>{it.L('In the UK, our clients trade through Binary (IOM) Ltd and Binary Investments (Europe) Ltd. In the Isle of Man, they trade through Binary (IOM) Ltd. In the European Union (except UK), they trade through Binary (Europe) Ltd and Binary Investments (Europe) Ltd. In the rest of the world, they trade through Deriv (SVG) LLC, Binary (V) Ltd, Deriv (BVI) Ltd and Binary (FX) Ltd.')}</p>
            </div>
        </div>
    </div>
);
