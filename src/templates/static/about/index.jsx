    ...
    <div className='about-us box-inlay-borders static_full'>
        ...
        <div className='container'>
            <div className='gr-parent'>
                ...
                <p>{it.L('In the UK, our clients trade through Deriv (MX) Ltd and Binary Investments (Europe) Ltd. In the Isle of Man, they trade through Deriv (MX) Ltd. In the European Union (except UK), they trade through Binary (Europe) Ltd and Binary Investments (Europe) Ltd. In the rest of the world, they trade through Deriv (SVG) LLC, Deriv (V) Ltd, Deriv (BVI) Ltd and Binary (FX) Ltd.')}</p>
            </div>
        </div>
    </div>
);
