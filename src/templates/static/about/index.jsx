            ...
            <div className='container section'>
                <div className='gr-padding-10 facts'>
                    ...
                    <div className='gr-row gr-parent'>
                        ...
                        <Box>
                            <BoxInner className='border-right-bottom gr-padding-30' image='license' text={it.L('Licensed and regulated in Malta, the United Kingdom, the Isle of Man, and Ireland. <a href=\'[_1]\'>Learn more</a>', it.url_for('regulation'))} />
