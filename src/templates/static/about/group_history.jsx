        ...
        <div className='gr-padding-10'>
            <div className='timeline'>
                <UL items={[
                    ...
                    { className: 'event',                header: it.L('Binary Bot released'),                   text: it.L('[_1] introduces an [_2]auto-trader programming tool[_3], allowing clients to develop their own automated trading robots with “drag-and-drop” simplicity.', it.website_name, it.language.lower === 'ja' ? '' : '<a href="https://bot.binary.com" target="_blank" rel="noopener noreferrer">', it.language.lower === 'ja' ? '' : '</a>') },
                    { className: 'event right featured', header: it.L('[_1] Shop introduced', it.website_name), text: it.L('[_1] launches an [_2]e-commerce site for branded merchandise[_3] – enabling clients, affiliates, and developers to buy and sell [_1] products.', it.website_name, it.language.lower === 'ja' ? '' : '<a href="https://shop.binary.com" target="_blank" rel="noopener noreferrer">', it.language.lower === 'ja' ? '' : '</a>') },
