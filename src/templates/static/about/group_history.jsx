        ...
        <div className='gr-padding-10'>
            <div className='timeline'>
                <UL items={[
                    ...
                    // { className: 'event',                   header: it.L('International Association of Forex Traders (IAFT) Awards 2018'), text: it.L('IAFT awards [_1] \'The Best Broker to Work with Binary Options\', as voted by more than 200,000 traders worldwide.', it.website_name) },
