        ...
        <div className='gr-padding-10'>
            <div className='timeline'>
                <UL items={[
                    ...
                    { className: 'event',                header: it.L('Global Brands Awards 2018'),                                           text: it.L('[_1] is awarded \'Best Trading Platform in Asia\' by Global Brands Magazine. The Global Brands Awards honours excellence in performance and exceptional service delivery. ', it.website_name) },
                    { className: 'event right',          header: it.L('International Association of Forex Traders (IAFT) Awards 2018'),       text: it.L('IAFT awards [_1] \'The Best Broker to Work with Binary Options\', as voted by more than 200,000 traders worldwide.', it.website_name) },
                    { className: 'event',                header: it.L('Global Banking & Finance Awards 2018'),                                text: it.L('[_1] wins \'Best Binary Company Asia Pacific\' in the Global Banking & Finance Awards 2018. This reflects our expertise and leadership in innovation and strategy.', it.website_name) },
