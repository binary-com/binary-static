        ...
        <div className='gr-padding-10'>
            <div className='timeline'>
                <UL items={[
                    ...
                    { className: 'event',          header: it.L('Deriv.com'),             text: it.L('Deriv.com was launched as the next-generation online trading platform. [_1] and Deriv collectively handle over 200 million transactions, with over USD 1 billion in turnover a year.', it.website_name) },
