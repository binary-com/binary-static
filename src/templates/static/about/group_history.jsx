        ...
        <div className='gr-padding-10'>
            <div className='timeline'>
                <UL items={[
                    ...
                    { className: 'event featured',       header: it.L('Regent Markets Group Ltd. renames to Deriv Ltd.'),                         text: it.L('Regent Markets Group Ltd. renames to Deriv Ltd., harmonising company and website branding throughout the organisation.') },
