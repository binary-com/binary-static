...
const Contact2 = () => (
    <div className='container' id='contact_content'>
        ...
        <div className='gr-padding-30' id='company_addresses'>
            ...
            <div className='gr-row'>
                <InfoBox padding='6' header={it.L('Malta')}       text={it.L('Binary (Europe) Ltd & Deriv Investments (Europe) Ltd, W Business Centre, Level 3, Triq Dun Karm, Birkirkara, BKR 9033')} />
            ...
            <div className='gr-row'>
                <InfoBox padding='6' header={it.L('Malaysia')} sub_header={it.L('Cyberjaya Office')} text={it.L('Deriv Group Services Sdn. Bhd., C-13, iTech Tower, Jalan Impact, Cyber 6, 63000 Cyberjaya, Selangor Darul Ehsan')} />
