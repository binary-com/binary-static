...
const Contact2 = () => (
    <div className='container' id='contact_content'>
        ...
        <div className='gr-padding-30' id='company_addresses'>
            ...
            <div className='gr-row'>
                <InfoBox padding='6' header={it.L('Malaysia')} sub_header={it.L('Cyberjaya Office')} text={it.L('Deriv test Services Sdn. Bhd., C-13, iTech Tower, Jalan Impact, Cyber 6, 63000 Cyberjaya, Selangor Darul Ehsan')} />
