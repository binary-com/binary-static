...
const JobApplicantPrivacyPolicy = () =>  (
    <div className='container'>
        <h2 data-anchor='job-applicant-policy'>{it.L('Job applicantion privacy policy')}</h2>
        <p>{it.L('Binary Group of companies (hereafter referred to as \'the Company\' and \'the It\') is committed to protecting the privacy and security of the applicant\'s personal information. This privacy notice sets out the types of data that the Company collects on the applicant. It also sets out how the Company collects and uses the applicant\'s personal data, how long it keeps them, and other relevant information about the applicant\'s data in accordance with the General Data Protection Regulation (EU) 2016/679 (hereafter referred to as \'GDPR\') and Data Protection Act 2018.')}</p>
        ...
        <ul className='bullet'>
            <li>{it.L('the applicant\'s personal details, including name, address, date of birth, nationality,gender, and contract details, comprising email address and telephone number')}</li>
        ...
        <p>{it.L('The Company shall further disclose information about the applicant internally whitin the Binary Group companies for the purpose of the recuitment exercise. The Company shall ensure that a data-sharing agreement is in place and that the applicant\'s data is held securely and in line with GDPR requirements. The Company shall further disclose information about the applicant when It is legally obligated to do so.')}</p>

        <h2 data-anchor='data-retention'>{it.L('Data retention')}</h2>
        <p>{it.L('The applicant\'s personal data shall be stored for a period of six months after the end of the relevant recruitment process if the applicant is unsuccessful in their job application or if they have declined an offer of employment with the Binary Group of companies. At the expiry of that period, the applicant\'s data is deleted or destroyed unless the Company is required to further retain the applicant\'s information to exercise or defend any legal claims.')}</p>
        ...
        <ul className='bullet'>
            <li>{it.L('The right to be informed of the use of their personal data, as reflectedin this privacy policy')}</li>
            ...
            <li>{it.L('The right to delete personal information, subject to the data retention practice of the Company')}</li>
        </ul>
        ...
        <p>{it.L('If the applicant have any questions about this privacy policy or if the applicant would like to exercise any of their rights, they should contact the Company\'s Data Protection Officer (DPO) by [_1].', '<a href="mailto:dpo@binary.com">dpo@binary.com</a>')}</p>
    </div>
);
