...
const UlText = ({
    ...
    <React.Fragment>
        ...
        {items ?
            <List className={className} items={items} />
        : undefined
        }
    </React.Fragment>
);
        ...
        <div className='gr-row'>
            <div className='gr-3 gr-padding-10 gr-hide-m gr-hide-p'>
                ...
                <div className='gr-12 gr-padding-10 sidebar-container'>
                    <SideBar className='information_technology' sidebar_items={[
                    ...
                    <SideBar className='compliance' sidebar_items={[
            ...
            <div className='gr-9 gr-padding-10 gr-12-m gr-12-p sections'>
                <div className='information_technology'>
                    <div className='invisible' id='devops_manager'>
                        ...
                        <UlText text={it.L('Duties and Responsibilities:')} className='bullet' items={[
                        ...
                        <UlText text={it.L('Requirements:')} className='bullet' items={[
                ...
                <div className='marketing'>
                    <div className='invisible' id='marketing_project_coordinator'>
                        ...
                        <UlText text={it.L('Preferences:')} className='bullet' items={[
                    ...
                    <div className='invisible' id='proofreader'>
                        ...
                        <UlText text={it.L('Duties and Responsibilities:')} className='bullet'
