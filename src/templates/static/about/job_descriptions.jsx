...
<div className='open-positions container'>
    <div className='gr-parent static_full'>
        ...
        <Row id='information_technology' title={it.L('Information Technology')} sections={[
        ...
        <Row id='quality_assurance' title={it.L('Quality Assurance')} sections={[
        ...
        <Row id='quantitative_analysis' title={it.L('Quantitative Analysis')} sections={[
        ...
        <Row id='marketing' title={it.L('Marketing')} sections={[
        ...
        <Row id='accounting' title={it.L('Accounting')} sections={[
        ...
        <Row id='compliance' title={it.L('Compliance')} sections={[
        ...
        <Row id='customer_support' title={it.L('Customer Support')} sections={[
        ...
        <Row id='human_resources' title={it.L('Human Resources')} sections={[
        ...
        <Row id='administrator' title={it.L('Administrator')} sections={[
        ...
        <Row id='internal_audit' title={it.L('Internal Audit')} last sections={[
