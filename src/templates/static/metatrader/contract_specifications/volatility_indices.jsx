    ...
    return (
        <div id='volatility_specs' className='gr-row'>
            ...
            <div className='gr-12 gr-padding-10'>
                ...
                <p>{it.L('To learn more, read our <a href="[_1]">CFD Margin Policy</a> that further explains our 50% forced liquidation level for Volatility Indices.', it.url_for('get-started-beta/cfds#margin-policy'))}</p>
            </div>
        </div>
    );
};
