    ...
    return (
        <div id='forex_specs' className='gr-row'>
            ...
            <div className='gr-12 gr-padding-10'>
                ...
                <p>{it.L('To learn more, read our <a href="[_1]">Forex Margin Policy</a> that further explains our 100% forced liquidation level for Forex.', it.url_for('get-started-beta/forex#margin-policy'))}</p>
