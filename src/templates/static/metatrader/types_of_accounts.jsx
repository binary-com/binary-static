                    ...
                    <Table
                        ...
                        data={{
                            ...
                            tbody: [
                                ...
                                [{ text: <Row number={1}  text={it.L('Leverage')} /> },               { text: it.L('1:1000 - 1:5') },                   { text: it.L('1:100') },                          { text: it.L('1:1000 - 1:300') }],
                                [{ text: <Row number={2}  text={it.L('Order execution')} /> },        { text: it.L('Market') },                         { text: it.L('Market') },                         { text: it.L('Market') }],
                                [{ text: <Row number={3}  text={it.L('Spread')} /> },                 { text: it.L('Variable') },                       { text: it.L('Variable') },                       { text: it.L('Fixed') }],
                                ...
                                [{ text: <Row number={7}  text={it.L('Maximum ticket size')} /> },    { text: it.L('[_1] lots', '10') },                { text: it.L('[_1] lots', '20') },                { text: it.L('[_1] lots', '100') }],
                    ...
                    <Table
                        ...
                        data={{
                            ...
                            tbody: [
                                ...
                                [{ text: <Row number={1}  text={it.L('Leverage')} /> },               { text: it.L('1:30 - 1:2') },         { text: it.L('1:1000 - 1:300') }],
                                ...
                                [{ text: <Row number={7}  text={it.L('Maximum ticket size')} /> },    { text: it.L('[_1] lots', '10') },    { text: it.L('[_1] lots', '100') }],
