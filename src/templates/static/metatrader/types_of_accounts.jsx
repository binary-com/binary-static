                    ...
                    <Table
                        ...
                        data={{
                            ...
                            tbody: [
                                ...
                                [{ text: <Row             text={it.L('Trading instruments')} /> },    { text: it.L('FX-majors (standard/micro lots), FX-minors, Commodities, Cryptocurrencies') }, { text: 'FX-majors, FX-minors, FX-exotics' },     { text: it.L('Synthetics') }],
                            ],
                        }}
