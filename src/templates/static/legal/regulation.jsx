    ...
    return (
        <div className='static_full'>
            ...
            <Box header={it.L('Binary (SVG) Ltd.')} >
                <p>{it.L('Binary (SVG) Ltd., registered in St. Vincent and the Grenadines. Clients from the rest of the world (excluding certain countries such as the USA, Canada, St. Vincent and the Grenadines, Hong Kong) will have their account opened with Binary (SVG) Ltd.')}</p>
                <p>{it.L('[_1] is not available in St. Vincent and the Grenadines and is not regulated or supervised by any regulatory body in the St. Vincent and the Grenadines\' financial system.', it.website_name)}</p>
            </Box>
