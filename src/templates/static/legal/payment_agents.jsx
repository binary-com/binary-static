...
const PaymentAgents = () => (
    <div>
        ...
        <ol>
            ...
            <li>{it.L('The information outlined in Paragraph 1 of this section shall be submitted to [_1]partners@binary.com[_2]</a>.', '<a href="mailto:partners@binary.com">', '</a>')}</li>
