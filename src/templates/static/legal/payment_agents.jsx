...
const PaymentAgents = () => (
    <div>
        ...
        <ol>
            ...
            <li>{it.L('The Agent shall not be authorized to offer its services, under this Agreement, to Clients who reside in restricted countries outlined in our terms and conditions (as amended from time to time), which are published on our website, <a href="[_1]">www.binary.com.</a>', it.url_for('signup'))}</li>
        </ol>
