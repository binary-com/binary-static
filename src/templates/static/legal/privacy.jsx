...
const Privacy = () => (
    <div>
        ...
        <p>{it.L('We also collect basic tax residence information for the purposes of CRS/FATCA compliance. The tax information you provide may only be disclosed to the authorities legally charged with collecting this information for CRS/FATCA reporting and only to the extent to which Binary.com is legally obliged to collect it from and disclose it to. We don’t use, disclose or process this information in any other way at any time.')}</p>
        <p>{it.L('You may update your personal information at any time by logging in to the "Settings" section of your account. It is your responsibility to ensure that Binary.com is promptly and continually informed of any change in your personal information.')}</p>

        <h2 data-anchor>{it.L('Profiling and Categorisation')}</h2>
        ...
        <h2 data-anchor>{it.L('Cookies and Device Information')}</h2>
        ...
        <p>{it.L('By using or interacting with our website, you are giving permission to the use of the Google Analytics User ID Feature, which allows Google to capture your Binary.com login ID such as VRTC1234, CR1234, and MF1234. When this feature is enabled, no other personally identifiable information other than your Binary.com login ID, or other data which can be linked to such information by Google, is shared with or disclosed to Google.')}</p>

        <h2 data-anchor>{it.L('Transfer of Data')}</h2>
        ...
        <h2 data-anchor>{it.L('Consent')}</h2>
        ...
        <h2 data-anchor>{it.L('Right to Object')}</h2>
        ...
        <p>{it.L('If you choose to close your Binary.com account, your data will be kept only for as long as necessary for us to meet our legal and regulatory obligations on data retention. We will delete your data once the applicable retention period expires.')}</p>
        ...
        <h2 data-anchor>{it.L('Data Protection Officer')}</h2>
