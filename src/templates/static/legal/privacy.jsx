...
const Privacy = () => (
    <div>
        ...
        <p>{it.L('You may update your personal information at any time by logging in to the "Settings" section of your account. It is your responsibility to ensure that [_1] is promptly and continually informed of any change in your personal information.', it.website_name)}</p>
        ...
        <p>{it.L('By using or interacting with our website, you are giving permission to the use of the Google Analytics User ID Feature, which allows Google to capture your [_1] login ID such as VRTC1234, CR1234, and MF1234. When this feature is enabled, no other personally identifiable information other than your [_1] login ID, or other data which can be linked to such information by Google, is shared with or disclosed to Google.', it.website_name)}</p>
