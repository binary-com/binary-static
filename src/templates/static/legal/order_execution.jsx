...
const OrderExecution = () => (
    <div>
        ...
        <p data-show='eucountry default'>{it.L('The client should note that the Company\'s duty to provide the client with best execution does not apply to any gambling products that the client places with the Company when there is no underlying financial market.')}</p>
