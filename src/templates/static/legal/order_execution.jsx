...
const OrderExecution = () => (
    <div>
        <h2>{it.L('Summary Order Execution Policy')}</h2>
        ...
        <h2>{it.L('Best Execution Factors')}</h2>
        ...
        <h2>{it.L('Specific Instructions')}</h2>
        ...
        <h2>{it.L('Monitoring and review of this Policy')}</h2>
