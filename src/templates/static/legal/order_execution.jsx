...
const OrderExecution = () => (
    <div>
        <h2 data-anchor>{it.L('Summary Order Execution Policy')}</h2>
        ...
        <p>{it.L('You should note that our duty to provide you with best execution does not apply to any gambling products that you place with us, where there is no underlying financial market.')}</p>
        ...
        <h2 data-anchor>{it.L('Best Execution Factors')}</h2>
        ...
        <h2 data-anchor>{it.L('Specific Instructions')}</h2>
        ...
        <h2 data-anchor>{it.L('No fiduciary duty')}</h2>
        ...
        <h2 data-anchor>{it.L('Monitoring and review of this Policy')}</h2>
