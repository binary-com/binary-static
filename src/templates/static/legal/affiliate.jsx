        ...
        <ol className='reset_ol'>
            ...
            <ListNested
                ...
                items={[
                    ...
                    { text: it.L('Any notice given or made under this Agreement to the Company shall be by email to [_1]. The Company shall send the Affiliate any notices given or made under this Agreement to the email address supplied on the Affiliate\'s application form or such other email addresses as notified by the Affiliate to the Company.', 'partners@binary.com') },
