...
const MAM = () => (
    <div>
        <h2>{it.L('Multi-Account Manager (MAM) Agreement')}</h2>
        ...
        <h2>D. {it.L('Provisions of Agreement')}</h2>
        <ol>
        ...
        <h2>G. {it.L('Representation or Warranty')}</h2>
