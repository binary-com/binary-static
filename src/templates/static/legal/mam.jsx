...
const MAM = () => (
    <div>
        <h2 data-anchor>{it.L('Multi-Account Manager (MAM) Agreement')}</h2>
        ...
        <h2 data-anchor>C. {it.L('Interpretation')}</h2>
        ...
        <h2 data-anchor>D. {it.L('Provisions of Agreement')}</h2>
        <ol>
        ...
        <h2 data-anchor>F. {it.L('Indemnification')}</h2>
        <ol>
        ...
        <h2 data-anchor>G. {it.L('Representation or Warranty')}</h2>
