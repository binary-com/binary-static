...
const Copyright = () => (
  <div>
    ...
    <p>
      {it.L('The materials comprising the [_1] website (including without limitation all articles, text, images, logos, compilation, systems, code and design) are Copyright 1999-<span class="currentYear" />Binary Group of companies. All rights reserved.', it.website_name)}
    </p>
    <p>
      {it.L(
