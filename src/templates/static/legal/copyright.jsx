...
const Copyright = () => (
    <div>
        ...
        <p>{it.L('The materials comprising the [_1] website (including without limitation all articles, text, images, logos, compilation, systems, code, and design) are under Copyright 1999-[_2] Binary Group companies with all rights reserved.', it.website_name, '<span class=\'currentYear\'></span>')}</p>
