        ...
        <ol>
            ...
            <li>{it.L('Closing an account')}
                <ol>
                    ...
                    <li>{it.L('Client\'s demo accounts will be deleted after 365 days of inactivity. [_1] Open positions and pending orders for demo accounts will be deleted after 180 days of inactivity.', '<br />')}</li>
