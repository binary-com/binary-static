                ...
                <ol>
                    ...
                    <li>{it.L('By opening an MT5 Real Account with [_1], you represent, warrant and undertake that:', it.website_name)}
                        <ol>
                            ...
                            <li>{it.L('You have sufficient experience and knowledge in matters of contract for difference to be capable of evaluating the merits and risks of acquiring contracts via this site and have done so without relying on any information contained in this site.')}</li>
                        </ol>
                    </li>
