                ...
                <ol>
                    ...
                    <li>{it.L('By opening an MT5 Real Account with [_1], the Client represents, warrants, and undertakes the following:', it.website_name)}
                        <ol>
                            ...
                            <li>{it.L('The Client is not residing in a restricted country such as St. Vincent and the Grenadines, Hong Kong, Israel, Jersey, Malaysia, Malta, Paraguay, the United Arab Emirates, the USA, Canada, or any other restricted country which has been identified by the FATF as having strategic deficiencies.')}</li>
