...
const TermsAndConditions = () => (
    <div id='mt-tnc'>
        ...
        <ol>
            ...
            <li data-show='eucountry'>{it.L('The Client understands that products based on a random number generator (the "Volatility Indices") are gambling products whereas products based on financial market indices (forex, indices, and commodities) are Financial Instruments.')}</li>
