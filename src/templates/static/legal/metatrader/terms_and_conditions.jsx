...
const TermsAndConditions = () => (
    <div id='mt-tnc'>
        ...
        <ol>
            ...
            <li>{it.L('You understand that products based on a random number generator (the "Volatility Indices") are gambling products whereas products based on financial market indices (forex, commodities) are financial instruments.')}</li>
        ...
        <h2 data-anchor>{it.L('B. Commencement and Cancellation')}</h2>
        <ol>
        ...
        <h2 data-anchor>{it.L('C. Provision of Services')}</h2>
        <ol>
        ...
        <h2 data-anchor>{it.L('D. Capacity')}</h2>
        <ol>
        ...
        <h2 data-anchor>{it.L('E. Account Management')}</h2>
        <ol>
            <li>{it.L('Opening an Account')}
                <ol>
                    <li>{it.L('To open an MT5 Real Account for financial instruments, you must have an authenticated Binary Options Real Account with [_1]. If you open an MT5 Real Account with Binary (Europe) Ltd you will be able to trade only Volatility contracts for difference. An MT5 Real Account cannot be opened in the absence of a Binary Options Real Account.', it.website_name)}</li>
            ...
            <li>{it.L('Fund Transfers')}
                <ol>
                    <li>{it.L('Funding of MT5 Real Account')}
                        <ol>
                            <li>{it.L('Your MT5 Real Account shall be funded by transferring funds from your Binary Options Real Account, subject to the availability and sufficiency of funds in your Binary Options Real Account. No fund transfers shall be made to any other account in the name of any third party.')}</li>
                            <li>{it.L('All fund transfers from your Binary Options Real Account to your MT5 Real Account must be made by you.')}</li>
                            <li>{it.L('There will be no charges for fund transfers from your Binary Options Real Account to your MT5 Real Account.')}</li>
                        </ol>
                    </li>
                    <li>{it.L('Withdrawal of Funds from MT5 Real Account')}
                        <ol>
                            <li>{it.L('Subject to the availability and sufficiency of funds in your MT5 Real Account, you may withdraw your funds from your MT5 Real Account to your Binary Options Real Account.')}</li>
                            <li>{it.L('We may, however, withhold your withdrawal request from your MT5 Real Account to your Binary Options Real Account, in whole or in part, if:')}
                                <ol>
            ...
            <li>{it.L('Self-Exclusion Limits')}
                <ol>
                    <li>{it.L('When a self-exclusion limit is set on your Binary Options Real Account registered with Binary (Europe) Ltd, your MT5 Real Account will be disabled until the self-exclusion limit on your Binary Options Real Account is removed.')}</li>
                </ol>
            </li>
            ...
            <li>{it.L('Closing an Account')}
                <ol>
                    ...
                    <li>{it.L('If your Binary Options Real Account is closed, your MT5 Real Account will automatically be closed as well.')}</li>
                </ol>
            </li>
        </ol>

        <h2 data-anchor>{it.L('F. Orders')}</h2>
        <ol>
        ...
        <h2 data-anchor>{it.L('G. Margin')}</h2>
        <ol>
            ...
            <li>{it.L('Margin Requirement and Calculation')}
                <ol>
                    ...
                    <li>{it.L('Whilst we endeavour to close out your Open Positions if and when the Margin Level for your MT5 Real Account reaches or falls below the Stop Out Level, we do not guarantee that your Open Positions will be closed when the Margin Level for your MT5 Real Account reaches the Stop Out Level.')}</li>
        ...
        <h2 data-anchor>{it.L('H. Regulatory Provisions')}</h2>
        <ol>
            ...
            <li>{it.L('Complaints and disputes')}
                <ol>
                    ...
                    <li>{it.L('Clients registered with any Binary Group company, and in particular with Binary (V) Ltd., Binary (C.R.). S.A., or Binary (Europe) Ltd can raise their unresolved disputes with management by submitting an email to <a href=\'mailto:[_1]\'>[_1]</a>.', 'complaints@binary.com')}</li>
                </ol>
            </li>
        </ol>

        <h2 data-anchor>{it.L('I. Quotes')}</h2>
        <ol>
        ...
        <h2 data-anchor>{it.L('J. Trading Transactions')}</h2>
        <ol>
        ...
        <h2 data-anchor>{it.L('K. Electronic Trading Platform and Transactions')}</h2>
        <ol>
        ...
        <h2 data-anchor>{it.L('M. Manifest Error')}</h2>
        <ol>
        ...
        <h2 data-anchor>{it.L('N. Force Majeure Events')}</h2>
        <ol>
        ...
        <h2 data-anchor>{it.L('O. Representations and Warranties')}</h2>
        <ol>
        ...
        <h2 data-anchor>{it.L('P. Indemnification')}</h2>
        <ol>
