...
const BIEL = () => (
    <div data-show='eucountry'>
        ...
        <p>{it.L('These supplementary terms and conditions (these "ST&Cs") apply solely to the clients of Deriv Investments (Europe) Ltd ("BIEL") and will govern the relationship between the client and BIEL when trading Financial Products (as defined below) with BIEL.')}</p>
