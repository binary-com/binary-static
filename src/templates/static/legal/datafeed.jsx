...
const DataFeed = () => (
    <div>
        <h2 data-anchor>{it.L('Data Feed')}</h2>
        ...
        <h2 data-anchor>{it.L('Filtering Stray Ticks')}</h2>
        ...
        <h2 data-anchor>{it.L('Smoothing out random noise')}</h2>
        ...
        <h2 data-anchor>{it.L('Differences with other data feeds')}</h2>
        ...
        <h2 data-anchor>{it.L('Weekend quotes')}</h2>
