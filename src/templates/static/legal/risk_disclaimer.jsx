...
const RiskDisclaimer = () => (
  <div>
    <h2>{it.L('Risk Disclaimer')}</h2>
    <p>
      {it.L(
        'This notice provides you with information about the risks associated with investment contracts, which you may invest in through services provided to you through [_1]. Binary Group provides a wide range of products including Binary Options relating to foreign exchange, indices, stocks and other investment products (\'Investment Products\') and binary bets such as those relating to the Volatility Indices (\'Gambling Products\').',
        it.website_name
      )}
    </p>
    <p>
      {it.L(
        'Binary Investments (Europe) Ltd, Binary (Europe) Ltd, Binary (IOM) Ltd, Binary (CR) SA and all other Binary Group members are sometimes referred to collectively as \'[_1]\', \'us\' or \'we\'.',
        it.website_name
      )}
    </p>
    <p>
    ...
    <p>
      {it.L(
        'You are advised that the Binary Options offered by [_1] are not traded under the rules of any recognised, designated or regulated exchange. Consequently, engaging in Binary Options trading may expose you to substantially greater risks than investments which are so traded.',
        it.website_name
      )}
    </p>
    ...
    <ul>
      <li>
        {it.L(
          'Derivative investment instruments such as Binary Options and related markets can be highly volatile. The prices of the underlying instrument which a Binary Options refers to may fluctuate rapidly and over wide ranges and may reflect unforeseeable events or changes in conditions, none of which can be controlled by you or [_1].',
          it.website_name
        )}
      </li>
      <li>
        {it.L(
          '[_1] makes efforts that the quoted prices of each underlying asset that a Binary Option refers to will be reasonably related to the actual prices of such asset available in the market. [_1] makes no warranty, expressed or implied, that the quoted prices represent prevailing market prices.',
          it.website_name
        )}
      </li>
      <li>
        {it.L(
          '[_1] may have access to information that is not available to you, may have acquired trading positions at prices that are not available to you, and may have interests different from your interests. [_1] does not undertake any obligation to provide you with market or other information we possess, nor to alter or refrain from our own trading.',
          it.website_name
        )}
      </li>
      <li>
    ...
    <h2>{it.L('Risks of Investment Products')}</h2>
    <p>
      {it.L(
