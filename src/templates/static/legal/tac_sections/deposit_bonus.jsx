...
const DepositBonus = () => (
  <div>
    ...
    <ol>
      <li>
        {it.L('The required minimum deposit has been made by the client AND')}
      </li>
      <li>
        {it.L(
    ...
    <ol>
      ...
      <li>
        {it.L(
          'Where an account is funded solely by means of a bonus code, the bonus amount plus any winnings can not be withdrawn until you have exceeded an account turnover of 25 times the bonus amount value. The maximum amount of winnings allowed on such accounts shall be 25 times the amount of such bonus amount.'
        )}
      </li>
      <li>
        {it.L(
