...
const Complaints = () => (
    <div>
        ...
        <p>{it.L('If you would like to file a complaint with regards to our service, kindly contact us on complaints@binary.com, providing any relevant details relating to your complaint. We shall investigate your enquiry and a response will be given to your enquiry. We will usually provide a final response within 10 working days (unless a further extension is required as permissible by law) from receipt of all relevant details.')}</p>
        <p className='invisible eu-show'>{it.L('If your complaint relates to our data processing practices, you may formally submit a complaint to the Information and Data Protection Commissioner (Malta) on the entity’s [_1]website[_2].',
        ...
        <p className='invisible eu-show'>{it.L('Alternatively, clients who are registered with both Binary (IOM) Ltd and Binary (Europe) Ltd, instead of submitting their dispute to IBAS, they can make use of the European Commission\'s Online Dispute Resolution (ODR) platform available [_1]here[_2].',
            '<a href="https://ec.europa.eu/odr" target="_blank" rel="noopener noreferrer">', '</a>')}
        </p>
        <p className='invisible eu-show'>{it.L('Clients registered with Binary Investments (Europe) Ltd can raise their unresolved disputes with the Office of the Arbiter for Financial Services. Contact details and guidance on making a complaint with the Arbiter’s Office can be found [_1]here[_2].',
