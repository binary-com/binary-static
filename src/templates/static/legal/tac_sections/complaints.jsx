...
const Complaints = () => (
    <div>
        ...
        <p>{it.L('Clients registered with Binary (C.R.) S.A. can raise their unresolved disputes with the management by submitting an email to complaints@binary.com.')}</p>
