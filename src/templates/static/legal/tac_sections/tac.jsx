...
const tac = () => (
  <div>
    ...
    <p>
      {it.L(
        'We are required by our licence to inform you about what happens to funds which we hold on account for you, and the extent to which funds are protected in the event of insolvency [_1].',
    ...
    <p>
      {it.L(
        'The company has various deposit methods available, each with their own timing for deposits, some of which might not be available for withdrawals. Full details of deposits and withdrawals methods available including settlement times are available <a href="[_1]">here.</a>',
    ...
    <ul className='bullet'>
      <li>
        {it.L(
          'any Client that is employed in the banking and/or finance sector must only conduct trades through the website with the knowledge of his/her employer and in accordance with the employer’s policies; and that'
        )}
      </li>
      <li>
        {it.L(
    ...
    <p>
      {it.L('You may only open an account at this site on condition that:')}
      <ul className='bullet'>
        <li>
          {it.L(
            'you have read this Legal Terms and Conditions page in full and understood that you will be buying and selling financial contracts subject to these terms and conditions;'
          )}
        </li>
        <li>
          {it.L(
        ...
        <li>
          {it.L(
            'you are not resident in a restricted country such as Bosnia and Herzegovina, Costa Rica, Democratic People\'s Republic of Korea (DPRK), Ethiopia, Hong Kong, Iran, Iraq, Israel, Jersey, Malaysia, Malta, Syria, Uganda, USA, Vanuatu or Yemen;'
          )}
        </li>
        <li>
          {it.L(
            'you have sufficient experience and knowledge in matters of financial trading to be capable of evaluating the merits and risks of acquiring financial contracts via this site and have done so without relying on any information contained in this site.'
          )}
        </li>
      </ul>
    </p>
