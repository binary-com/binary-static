...
const Tac = () => (
    <div>
        ...
        <p>{it.L('Internal currency transfers between accounts are allowed up to a maximum of USD 2000 or equivalent. Transfers are allowed between any available currency pair but cannot be done between the Binary and MT5 accounts.')}</p>
