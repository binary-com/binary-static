...
const Tac = () => (
    <div>
        ...
        <p>{it.L('The client may communicate with us through this website or by means of e-mail, phone or, exceptionally, by post. Details can be found in the Contact us page. All calls are recorded for training and monitoring purposes.')}</p>
