...
const Tac = () => (
    <div>
        ...
        <p>{it.L('Transfers between Binary fiat and crypto accounts are allowed up to a maximum of USD 2,500.00 or equivalent. Transfers between Binary and MT5 accounts are allowed for fiat currencies only.')}</p>
