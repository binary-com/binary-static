...
const biel = () => (
  <div>
    ...
    <p>
      {it.L(
        'These ST&Cs form part of and need to be read together with the General Terms and Conditions relating to the use of [_1].',
        it.website_name
      )}
    </p>
    <p>
    ...
    <h2>{it.L('Appropriateness Test')}</h2>
    <p>
      {it.L(
    ...
    <h2>{it.L('Best Execution Policy')}</h2>
    <p>
      {it.L(
    ...
    <p>
      {it.L(
        'BIEL forms part of [_1]the Investor Compensation Scheme[_2] (the "Scheme") which is a rescue fund for investors that are clients of failed investment firms licensed by the MFSA. The Scheme covers 90% of the Company\'s net liability to a client in respect of investments which qualify for compensation under the Investment Services Act subject to a maximum payment to any one person of €20,000. The Scheme is based on EC Directive 97/9.',
