...
const Biel = () => (
    <div>
        ...
        <p>{it.L('These Supplementary Terms and Conditions (these "ST&Cs") apply solely to clients ("you") of Binary Investments (Europe) Ltd ("BIEL", "we" or "us") and will govern the relationship between you and us when trading Financial Products (as defined in the Key Information documents [_1]here[_2]) with us.', `<a href=${it.url_for('regulation')}>`, '</a>')}</p>
        ...
        <h2 data-anchor>{it.L('Appropriateness Test')}</h2>
        ...
        <h2 data-anchor>{it.L('Best Execution Policy')}</h2>
        ...
        <h2 data-anchor>{it.L('Investor Compensation Scheme')}</h2>
