                ...
                items={[
                    ...
                    },
                    {
                        ...
                        list_nested: [
                            ...
                            { text: it.L('The Company reserves the right to modify, supplement, or replace these Terms at any time. Any material changes will be notified to the Programmer. The Programmer\'s continued registration with the [_1] API and the Programmer\'s continued use of the [_1] API will constitute binding acceptance of such changes.', it.website_name) },
                        ],
                    },
                    {
            ...
            <ListNested
                ...
                items={[
                    ...
                    },
                    {
                        ...
                        list_nested: [
                            { text: it.L('The Company may release subsequent versions of the [_1] API and require that the Programmer uses those subsequent versions. The Programmer\'s continued use of the APIs following a subsequent release will be deemed the Programmer\'s acceptance of modifications.', it.website_name) },
                        ...
                        list_nested: [
                            {
                                ...
                                list_nested: [
                                    { text: it.L('The Programmer is in default or breach of any covenant, obligation, or condition contained in this Agreement, and if such default is not cured within seven days of receipt of written notice from the Company.') },
