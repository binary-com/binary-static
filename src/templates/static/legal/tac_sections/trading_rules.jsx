    ...
    <div>
        ...
        <p>{it.L('The Company may impose certain rules and restrictions on the placing of market orders on this website. Such rules may change from time to time, according to market conditions and other factors. The following indicative rules are currently in place:')}
            <ul className='bullet'>
                ...
                <li>{it.L('Contracts offered by Binary Investments (Europe) Ltd have a minimum purchase price of USD/GBP/EUR 5.Contracts offered by Binary Investments (Europe) Ltd. have a minimum purchase price of USD/GBP/EUR 5.')}</li>
            ...
            <p><span style={{ fontWeight: 'bold' }}>{it.L('Contract payouts shall be determined by the Company by reference to the market quotes as displayed on the website relevant to the underlying index(ices) of the contract(s) ')}</span><span>{it.L('or from the interbank trading data received by the Company for forex quotes or commodity prices as displayed on the website, provided that the Company shall have the right to make corrections to such data in the event of mispriced or typographically incorrect data. Clients should note that different markets may close at different times during the day due to local trading hours and time zones.')}</span></p>
            ...
            <p>{it.L('Due to the responsibilities under responsible gaming, Binary.com reserves the right to assess and safeguard the client’s account by setting limits to the client’s activity as deemed proportionate and necessary for their protection.')}</p>
        </p>
    </div>
);
