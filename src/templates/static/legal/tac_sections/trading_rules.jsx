...
const TradingRules = () => (
    <div>
        ...
        <p>{it.L('The Company may impose certain rules and restrictions on the placing of market orders on this website. Such rules may change from time to time, according to market conditions and other factors. The following indicative rules are currently in place:')}
            ...
            <p data-show='eucountry'>{it.L('Due to the responsibilities under responsible gamin, [_1] reserves the right to assess and safeguard the client\'s account by setting limits to the client\'s activity as deemed proportionate and necessary for their protection.', it.website_name)}</p>
        </p>
    </div>
);
