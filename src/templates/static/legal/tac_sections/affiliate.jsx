...
const Affiliate = () => (
    <div>
        <h2 data-anchor='affiliate-terms-and-conditions'>{it.L(
            '[_1]\'s Affiliate Programme terms and conditions',
            it.website_name,
        )}
        </h2>
        <ol className='reset_ol'>
            ...
            <ListNested
                ...
                items={[
                    {
                        text: it.L(
                            'The Affiliate must provide such information to the licensee as they may reasonably require in order to be able to comply with their information reporting and other obligations[_1] to the UK Gambling Commission[_2].',
                            '<span data-show="eucountry">',
                            '</span>',
                        ),
                    },
                    {
                    ...
                    {
                        text: it.L(
                            'The Affiliate must ensure that any historical trading records and performance figures presented to the Affiliate\'s referrals related to trading on the website [_1] are accurate and not misleading.',
                            it.website_name,
                        ),
                    },
                    {
            ...
            <ListNested
                ...
                items={[
                    ...
                    {
                        text: it.L(
                            'The Affiliate shall not hold or pool the Affiliate\'s referrals\' funds or third-party funds into the Affiliate\'s own account held with [_1].',
                            it.website_name,
                        ),
                    },
            ...
            <ListNested
                ...
                items={[
                    {
                        text: it.L(
                            'Ownership and content of the [_1] website remains the Company\'s respective properties and shall not be deemed to have been transferred to the Affiliate through any act or omission in respect of this Agreement.',
                            it.website_name,
                        ),
                    },
                    {
            ...
            <ListNested
                ...
                items={[
                    {
                        text: it.L(
                            'Any form of spam will result in the Affiliate\'s account being placed under review and all funds due being withheld pending an investigation into the Affiliate\'s account. The Affiliate needs to be aware that [_1] is liable to incur expenses in dealing with spam generated mail and these same expenses will be deducted from the Affiliate\'s account. In this instance, the amount determined will be fair and deemed final and acceptable based on good faith, and such amount will be collectable by law and deemed to have been accepted by the Affiliate as fair and reasonable and as agreed to by registration as an affiliate of [_1].',
                            it.website_name,
                        ),
                    },
                    {
            ...
            <ListNested
                ...
                items={[
                    ...
                    {
                        text: it.L(
                            'The Company provides the [_1] website on an "as is" and "as available" basis and gives no warranty that the [_1] website will be free of errors, or that errors will be corrected, or that the Company\'s website is free of any third-party interferences such as hackers or any other harmful components that arise outside of the Company\'s control.',
                            it.website_name,
                        ),
                    },
                ]}
            ...
            <ListNested
                ...
                items={[
                    ...
                    {
                        text: it.L(
                            'Any notice given or made under this Agreement to the Company shall be by email to [_1]. The Company shall send the Affiliate any notices given or made under this Agreement to the email address supplied on the Affiliate\'s application form or such other email addresses as notified by the Affiliate to the Company.',
