        ...
        <ol className='reset_ol'>
            ...
            <ListNested
                ...
                items={[
                    ...
                    { text: it.L('The Affiliate shall not place trades on he Affiliate’s referrals\' behalf.') },
            ...
            <ListNested
                ...
                items={[
                    ...
                    { text: it.L('Commissions will be earned throughout the life of the client, on all transactions the client undertakes with the Company, for as long as the Affiliate remain a member of this affiliate programme. The company reserves the right to cancel the commissions that are not reclaimed after 2 years.') },
            ...
            <ListNested
                ...
                items={[
                    ...
                    { text: it.L('The Company provides the [_1] website on an “as is” and “as available” basis and gives no warranty that the Binary.com website will be free of errors, or that errors will be corrected, or that the Company’s website is free of any third-party interferences such as hackers or any other harmful components that arise outside of the Company\'s control.', it.website_name) },
                ]}
            />
            ...
            <ListNested
                ...
                items={[
                    ...
                    { text: it.L('Either party may terminate this Agreement on the delivery of one weeks\' prior written notice to the other party.') },
                    {
