...
const Complaints = () => (
    <div>
        ...
        <p data-show='eucountry'>{it.L('If you reside in the UK and you are unhappy with our response you may escalate your complaint to the [_1]Financial Ombudsman Service[_2].',
