...
const Complaints = () => (
    <div>
        ...
        <p data-show='eucountry'>{it.L('Clients registered with Binary (IOM) Ltd can formally submit a complaint to their local Supervisory Authority.')}</p>
        ...
        <p data-show='eucountry'>{it.L('Clients registered with Binary (IOM) Ltd or Binary (Europe) Ltd can raise their unresolved disputes with the alternative dispute resolution entity IBAS by filling the adjudication form on the ADR entity\'s [_1]website[_2]. Alternatively, they can make use of the European Commission\'s Online Dispute Resolution (ODR) platform available [_3]here[_4]. Clients registered with Binary (Europe) Ltd can also refer their unresolved disputes to the Malta Gaming Authority via the [_5]Player Support Unit[_6].',
        ...
        <p data-show='eucountry'>{it.L('Clients registered with Deriv Investments (Europe) Ltd can raise their unresolved disputes with the Office of the Arbiter for Financial Services. Contact details and guidance on making a complaint with the Arbiter\'s Office can be found [_1]here[_2].',
