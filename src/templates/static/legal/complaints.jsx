...
const Complaints = () => (
    <div>
        ...
        <p data-show='eucountry'>{it.L('Clients registered with Binary (IOM) Ltd or Binary (Europe) Ltd can raise their unresolved disputes with the alternative dispute resolution entity IBAS by filling the adjudication form on the ADR entity\'s [_1]website[_2]. Alternatively, they can make use of the European Commission\'s Online Dispute Resolution (ODR) platform available [_3]here[_4].',
            '<a href=\'https://www.ibas-uk.com\' target=\'_blank\' rel=\'noopener noreferrer\'>', '</a>', '<a href="https://ec.europa.eu/odr" target="_blank" rel="noopener noreferrer">', '</a>')}
        </p>
