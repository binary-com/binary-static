...
const Complaints = () => (
    <div>
        ...
        <p data-show='eucountry'>{it.L('Clients registered with Deriv (IOM) Ltd can formally submit a complaint to their local Supervisory Authority.')}</p>
        ...
        <p data-show='eucountry'>{it.L('Clients registered with Deriv (IOM) Ltd or Deriv (Europe) Ltd can raise their unresolved disputes with the alternative dispute resolution entity IBAS by filling the adjudication form on the ADR entity\'s [_1]website[_2]. Alternatively, they can make use of the European Commission\'s Online Dispute Resolution (ODR) platform available [_3]here[_4]. Clients registered with Deriv (Europe) Ltd can also refer their unresolved disputes to the Malta Gaming Authority via the [_5]Player Support Unit[_6].',
