...
const CodeOfConduct = () => (
    <div>
        <h2 data-anchor='code-of-conduct'>{it.L('Code of Conduct for Business Partners')}</h2>
        <h2 data-anchor='introduction'>{it.L('Introduction')}</h2>
        <p>{it.L(
        ...
        <p>{it.L(
            'If you wish to seek guidance on any aspect these Business Principles, you should contact compliance@binary.com.')}
        </p>
        <h2 data-anchor='legal-and-regulatory-compliance'>{it.L('Legal and regulatory compliance')}</h2>
        <p>{it.L(
        ...
        <h2 data-anchor='responsible-trading'>{it.L('Responsible trading')}</h2>
        <p>{it.L(
        ...
        <h2 data-anchor='transparency'>{it.L('Transparency')}</h2>
        <p>{it.L(
        ...
        <h2 data-anchor='reliability'>{it.L('Reliability')}</h2>
        <p>{it.L(
        ...
        <p>{it.L('This is one of our core commitments to clients.')}
        </p>
        ...
        <h2 data-anchor='anti-money-laundering'>{it.L('Anti-money laundering')}</h2>
        <p>{it.L(
        ...
        <p>{it.L(
            'Clients may trade on our platforms only when they are using their own money and are drawing on funds that have been acquired honestly. If you have any suspicion that clients are using money that has been acquired dishonestly, you must inform compliance@binary.com.  In such cases, we may decide to conduct checks on the client’s status and background. Binary.com management will decide what information needs to be reported to government officials and through what channels.')}
        </p>
        <h2 data-anchor='no-insider-trading'>{it.L('No insider trading')}</h2>
        <p>{it.L(
        ...
        <p>{it.L(
            'You must ensure that potential clients are aware of the prohibition on insider trading based on confidential information. If you have any suspicion that such trading is taking place you must inform compliance@binary.com.')}
        </p>
        <h2 data-anchor='fair-competition'>{it.L('Fair Competition')}</h2>
        <p>{it.L(
        ...
        <h2 data-anchor='conflicts-of-interest'>{it.L('Conflicts of interest')}</h2>
        <p>{it.L(
        ...
        <p>{it.L(
            'If an actual or potential conflict appears in the course of your work, they must declare it to compliance@binary.com.')}
        </p>
        <h2 data-anchor='books-and-records'>{it.L('Books and records')}</h2>
        <p>{it.L(
        ...
        <p>{it.L('You must ensure that you fill in all records accurately and in as much detail as required.')}
        </p>
    </div>
);
