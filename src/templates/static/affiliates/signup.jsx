                ...
                <div className='tab-content'>
                    <TabContentContainer>
                        <TabContent id='revenue_share'>
                            <p>{it.L('Profit from increasingly higher payouts with tiered and laddered commission rates that reward you based on the net revenue generated by your referred clients.')}</p>
