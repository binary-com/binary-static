    ...
    <div className='static_full affiliates-signup-page'>
        <div className='container'>
            ...
            <div className='gr-padding-20'>
                ...
                <div className='steps'>
                    <Step circle_no='1' header={it.L('Sign up')}                       text={it.L('Getting started is free and easy – just <a href=\'[_1]\' target="_blank">fill out the application form</a>, choose from two types of commission plans and wait for our approval.', it.affiliate_signup_url)} />
                ...
                <div className='tab-content'>
                    <TabContentContainer>
                        <TabContent id='revenue_share'>
                            <p className='mobile-text-small'>{it.L('Profit from increasingly higher payouts with tiered and laddered commission rates that reward you based on the net revenue generated by your referred clients.')}</p>
