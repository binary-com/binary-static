...
const Head = () => (
    <head>
        ...
        <meta name='description' content={` ${it.L('[_1] gives everyone an easy way to participate in the financial markets. Trade with as little as $1 USD on major currencies, indices, commodities, and synthetic indices.', it.broker_name)}`} />
