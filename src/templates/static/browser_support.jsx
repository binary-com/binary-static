    ...
    <React.Fragment>
        ...
        <div className='gr-parent clear'>
            <div className='gr-row'>
                ...
                <Browsers id='firefox' href='https://www.mozilla.org/en-US/firefox/new/' company='Binary (IOM) Ltd' header='Mozilla Firefox 47+' items={[
        ...
        <div className='gr-parent clear'>
            <div className='gr-row'>
                ...
                <Browsers id='opera' href='https://www.opera.com/' company='Binary (C.R.) S.A.' header='Opera 38+' items={[
        ...
        <div className='gr-parent'>
            <div className='gr-row'>
                ...
                <Browsers id='microsoft_edge' href='https://www.microsoft.com/en-us/download/details.aspx?id=48126' company='Binary Ltd' header='Microsoft Edge 12+' items={[
