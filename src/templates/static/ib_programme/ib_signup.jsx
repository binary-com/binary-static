        ...
        <div className='container'>
            ...
            <div className='gr-padding-20 center-text'>
                ...
                <div className='steps'>
                    ...
                    <Step circle_no='2' header={it.L('Introduce [_1]', it.website_name)} text={it.L('Use your unique affiliate link and the marketing tools we provide to advertise our MT5 service to your audience.')} />
