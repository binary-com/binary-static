    ...
    <div className='container'>
        <div className='open-source-projects static_full gr-row'>
            ...
            <div className='gr-9 gr-12-m gr-parent'>
                <Section id='open-source-projects-section' image='1.svg' order_first header={it.L('[_1] open-source projects', it.website_name)}
                ...
                <Section id='translations' image='5.png' header={it.L('Translations')}
