            ...
            <div className='gr-9 gr-12-m'>
                ...
                <Section id='contract-specification' header={it.L('Cryptocurrency contract specifications')}>
                    <Table scroll data={{
                        ...
                        tbody: [
                            [{ text: 'BTC/USD' }, { text: it.L('Bitcoin vs US Dollar')          }, { text: one }, { text: hundredth }, { text: hundredth }, { text: twenty_percent }],
                            [{ text: 'ETH/USD' }, { text: it.L('Ethereum vs US Dollar')         }, { text: one }, { text: tenth     }, { text: hundredth }, { text: twenty_percent }],
                            [{ text: 'LTC/USD' }, { text: it.L('Litecoin vs US Dollar')         }, { text: one }, { text: tenth     }, { text: hundredth }, { text: twenty_percent }],
                            [{ text: 'BCH/USD' }, { text: it.L('Bitcoin Cash vs US Dollar')     }, { text: one }, { text: hundredth }, { text: hundredth }, { text: twenty_percent }],
                            [{ text: 'ETC/USD' }, { text: it.L('Ethereum Classic vs US Dollar') }, { text: one }, { text: one       }, { text: one       }, { text: twenty_percent }],
                            [{ text: 'ZEC/USD' }, { text: it.L('Zcash vs US Dollar')            }, { text: one }, { text: one       }, { text: one       }, { text: twenty_percent }],
                            [{ text: 'XMR/USD' }, { text: it.L('Monero vs US Dollar')           }, { text: one }, { text: one       }, { text: one       }, { text: twenty_percent }],
                            [{ text: 'XRP/USD' }, { text: it.L('Ripple vs US Dollar')           }, { text: one }, { text: hundred   }, { text: hundred   }, { text: twenty_percent }],
                            [{ text: 'DSH/USD' }, { text: it.L('Dash vs US Dollar')             }, { text: one }, { text: one       }, { text: one       }, { text: twenty_percent }],
                        ],
                    }} />
