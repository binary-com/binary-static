        ...
        <div className='gr-row'>
            ...
            <div className='gr-9 gr-12-m'>
                ...
                <Section id='contract-specification' header={it.L('Cryptocurrency contract specifications')}>
                    ...
                    <HeaderSecondary header={it.L('Commission scheme')} />
                    <Table
                        scroll
                        data={{
                            thead: [[
                            ...
                            tbody: [
                                ...
                                [{ text: 'ETH/USD' }, { text: it.L('Ethereum vs US Dollar')     }, { text: pointsix  }, { text: negtwenty }, { text: negtwenty }],
                                [{ text: 'LTC/USD' }, { text: it.L('Litecoin vs US Dollar')     }, { text: pointsix  }, { text: negtwenty }, { text: negtwenty }],
                                [{ text: 'BCH/USD' }, { text: it.L('Bitcoin Cash vs US Dollar') }, { text: pointsix  }, { text: negtwenty }, { text: negtwenty }],
                                [{ text: 'XRP/USD' }, { text: it.L('Ripple vs US Dollar')       }, { text: pointsix  }, { text: negtwenty }, { text: negtwenty }],
                                [{ text: 'DSH/USD' }, { text: it.L('Dash vs US Dollar')         }, { text: pointfive }, { text: negtwenty }, { text: negtwenty }],
                                [{ text: 'EMC/USD' }, { text: it.L('Emercoin vs US Dollar')     }, { text: pointsix  }, { text: negtwenty }, { text: negtwenty }],
                                [{ text: 'EOS/USD' }, { text: it.L('EOS vs US Dollar')          }, { text: pointsix  }, { text: negtwenty }, { text: negtwenty }],
                            ],
                        }}
                    />
                    <HeaderSecondary header={it.L('How to read the commission scheme table')} />
