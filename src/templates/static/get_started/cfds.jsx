        ...
        <div className='gr-row'>
            ...
            <div className='gr-9 gr-12-m'>
                ...
                <Section id='contract-specification' header={it.L('CFD contract specifications')}>
                    ...
                    <p>{it.L('Range Beak index fluctuates within a range between an upper and lower price level, also known as borders. When it hits either border, the index occasionally breaks through the range with a jump or crash, creating a new range. There are two types:')}</p>
