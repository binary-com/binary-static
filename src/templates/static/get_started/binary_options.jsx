                    ...
                    <Section id='glossary' header={it.L('Glossary')}>
                        <Glossary
                            glossary={[
                                ...
                                { word: it.L('Sell option'),         dataAnchor: 'sell-option',         definition: it.L('It is sometimes possible to sell an option before the expiry of a trade, but only if a fair price can be determined. If this option is available, you will see a \'Sell at Market\' button inside the popup window, after clicking on the \'View\' button next to your trade in the portfolio.') },
