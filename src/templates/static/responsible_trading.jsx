    ...
    <div className='static_full' id='responsible-trading'>
        <div className='container'>
            ...
            <div data-show='eucountry'>
                ...
                <p>{it.L('[_1] also provides links to an online quiz to assess a potential gambling problem and an online gambling calculator to see how much you can really spend.', '<a target=\'_blank\' href=\'https://www.begambleaware.org/\' rel=\'noopener noreferrer\'>BeGambleAware</a>')}</p></div>
