                ...
                <div className='gr-9 gr-12-m'>
                    ...
                    <Section id='types-of-trades' header={it.L('Types of trades')}>
                        ...
                        <SectionLarge header={it.L('In/Out')} image='types-of-trades/in_out' text={it.L('There are two types of In/Out trades:')}>
                            <ListStrong header={it.L('Ends In/Out')}       text={it.L('Predict that the market stops inside or outside two price targets at the end of the time period')} />
                            <ListStrong header={it.L('Stays In/Goes Out')} text={it.L('Predict that the market stays inside or goes outside two price targets any time during the contract period')} />
                        </SectionLarge>
