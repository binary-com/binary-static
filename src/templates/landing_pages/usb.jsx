            ...
            <div className='navbar-container'>
                ...
                <div className='nav-col-right'>
                    ...
                    <div id='push-nav' className='topnav'>
                        ...
                        <a className='page-scroll' href='#usb-clients'>{('USB clients')}</a>
            ...
            <div className='container center-text'>
                <div className='gr-row justify-content-between'>
                    ...
                    <div className='gr-3 gr-12-t gr-12-m gr-12-p mb-bottom-30'>
                        ...
                        <p>{('To redeem USB for USD, complete the ')}{it.broker_name}{(' KYC check, then perform the conversion using our ')}<a href='https://www.binary.com/en/cashier/account_transfer.html'>{('transfer between accounts')}</a> {('facility.')}</p>
                    </div>
                    <div className='gr-3 gr-12-t gr-12-m gr-12-p mb-bottom-30'>
                        <div className='icon-xl icon-peaceofmind' />
                        <h3 className='ft-400'>{('Peace of mind')}</h3>
                        <p>{('USB is backed by ')}{it.broker_name}{(' –– a profitable, 18-year-old company with')} <a href='https://www.binary.com/en/binary-in-numbers.html'>{('annual turnover exceeding USD 1 billion')}</a>.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div className='container center-text'>
                <div className='gr-row justify-content-between'>
                    ...
                    <div className='gr-3 gr-12-t gr-12-m gr-12-p mb-bottom-30'>
                        ...
                        <p className='content-inverse-color'>{('Hold your USB in any ERC20-compatible wallet, such as')} <a className='content-inverse-color' href='https://trustwalletapp.com/'>{('Trust Wallet')}</a>.</p>
                    </div>
                    <div className='gr-3 gr-12-t gr-12-m gr-12-p mb-bottom-30'>
            ...
            <div className='container center-text'>
                <div className='gr-row justify-content-between'>
                    ...
                    <div className='gr-3 gr-12-t gr-12-m gr-12-p mb-bottom-30'>
                        ...
                        <p>{('The source code of the USB token can be freely')} <a href='http://etherscan.io/address/0xaf8bef28181aa864b3b60cc88d1f3788c1025ecb'>{('audited on Etherscan')}</a>.</p>
                    </div>
                </div>
            </div>
        </div>
