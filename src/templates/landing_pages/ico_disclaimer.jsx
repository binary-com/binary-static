            ...
            <div className='container disclaimer'>
                ...
                <div className='gr-row invisible' id='disclaimer_form'>
                    <div className='gr-10 gr-push-1'>
                        ...
                        <p>
                            {it.L(
                                'Access to these materials is restricted in certain jurisdictions. Please indicate your country of residence. By clicking the “Submit” button below you certify that you are an individual resident in the country you stipulated.'
                            )}
                        </p>
                    ...
                    <div className='gr-10 gr-push-1 invisible' id='notice_msg'>
                        ...
                        <form id='frm_accept_second_notice' className='center-text'>
                            <label>
                                ...
                                <span>
                                    {it.L(
                                        'I have read and understood the above and confirm that I am suitably qualified to receive the information hereafter.'
                                    )}
                                </span>
                            </label>
                    ...
                    <div className='gr-10 gr-push-1 invisible' id='disclaimer_msg'>
                        ...
                        <div className='disclaimer-container'>
                            <p>
                                {it.L(
                                    'ELECTRONIC VERSIONS OF THE MATERIALS YOU ARE SEEKING TO ACCESS ARE BEING MADE AVAILABLE ON THIS WEBPAGE BY BINARY GROUP LTD. IN GOOD FAITH AND FOR INFORMATION PURPOSES ONLY.'
                                )}
                            </p>
                            <p>
                                {it.L(
                                    'Please read this notice carefully - it applies to all persons who view this webpage. Please note that the disclaimer set out below may be altered or updated, at any time in whole or in part at the sole discretion of Binary Group Ltd. (“Company”). You should read it in full each time you visit the site.'
                                )}
                            </p>
                            ...
                            <h2>
                                {it.L('Confirmation of understanding and acceptance of disclaimer')}
                            </h2>
                            <p>
                                {it.L(
                                    'BY CLICKING ON THE "AGREE" BUTTON, YOU CERTIFY (BOTH TO BINARY GROUP LTD., ITS EMPLOYEES, OFFICERS AND ITS ADVISORS) THAT:'
                                )}
                            </p>
                            <ul className='bullet'>
                                <li>
                                ...
                                <li>
                                    {it.L(
                                        'IN ORDER TO MAKE A BID FOR A TOKEN YOU MUST BE A BINARY.COM REGISTERED CLIENT WITH A BINARY.COM ACCOUNT, AND THAT YOU WILL PROVIDE BINARY GROUP LTD. WITH REQUESTED WRITTEN CERTIFICATIONS AS TO YOUR STATUS TO CONFIRM YOU ARE AN AUTHORISED PERSON;'
                                    )}
                                </li>
                                <li>
                                    {it.L(
                                        'YOU CONFIRM THAT IF YOU ARE DEEMED BY BINARY GROUP LTD. TO NOT BE AN AUTHORISED PERSON YOU WILL DESTROY THE MATERIAL AND WILL NOT DISTRIBUTE IT TO THIRD PARTIES;'
                                    )}
                                </li>
                                <li>
                                    {it.L('YOU ARE NOT IN THE UNITED STATES OR ANY OTHER RESTRICTED TERRITORY;')}
                                </li>
                                <li>
                                    {it.L(
                                ...
                                <li>
                                    {it.L(
                                        'YOU REPRESENT AND WARRANT THAT SHOULD YOU WISH TO MAKE ANY INVESTMENT IN BINARY GROUP LTD. OR PURCHASE OR SUBSCRIBE FOR ANY TOKENS YOU WILL SATISFY YOURSELF AS TO FULL OBSERVANCE OF THE LAWS OF ANY RELEVANT TERRITORY IN CONNECTION WITH ANY SUCH INVESTMENT INCLUDING OBTAINING ANY REQUISITE GOVERNMENTAL OR OTHER CONSENTS THAT MAY BE REQUIRED AND AS TO DUE AND PROPER COMPLIANCE THEREWITH; AND'
                                    )}
                                </li>
                                <li>
                                    {it.L('YOU HAVE READ, UNDERSTOOD AND AGREE TO THE DISCLAIMER ABOVE.')}
                                </li>
                            </ul>
                        </div>
                        <form id='frm_accept_disclaimer' className='center-text'>
                            <label>
                                ...
                                <span>
                                    {it.L(
                                        'I UNDERSTAND THAT THE DISCLAIMER ABOVE MAY AFFECT MY RIGHTS. I AGREE TO BE BOUND BY ITS TERMS.'
                                    )}
                                </span>
                            </label>
