                    ...
                    <div className='home-header-content lg-center'>
                        <div className='gr-row gr-row-align-middle'>
                            <div className='gr-5 gr-12-t gr-12-m gr-12-p'>
                                ...
                                <p><a className='button' href='https://grid.binary.me/download/BinaryGrid_v100.apk'><span className='button-lg'>{('Get Binary Grid now')}</span></a></p>
                            </div>
                ...
                <div className='container'>
                    ...
                    <div className='gr-row center-text'>
                        <div className='gr-3 gr-12-t gr-12-m gr-12-p col-step'>
                            ...
                            <p>{('Go')} <a href='https://grid.binary.me/download/BinaryGrid_v100.apk'>{('here')}</a> {('to download Binary Grid for Android.')}</p>
                        </div>
                        <div className='gr-3 gr-12-t gr-12-m gr-12-p col-step'>
                    ...
                    <div className='gr-row'>
                        <div className='gr-12 center-text'>
                            <a className='button' href='https://grid.binary.me/download/BinaryGrid_v100.apk'><span className='button-lg'>{('Get Binary Grid now')}</span></a>
                        </div>
                    </div>
                </div>
            </div>
