...
const Layout = ({
    ...
    <html>
        <head>
            ...
            <meta name='description' content={meta_description || it.L('[_1] gives everyone an easy way to participate in the financial markets. Trade with as little as $1 USD on major currencies, stocks, indices, and commodities.', it.broker_name)} />
