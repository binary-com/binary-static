...
const BinaryJapan = () => (
    <html>
                ...
                <div className='gr-6 gr-10-m gr-push-1-m'>
                    <div className='card'>
                        <div className='card-body'>
                            <div className='gr-row'>
                                <div className='gr-6 gr-12-m image'>
        ...
        <section className='pattern pattern-confetti pattern-stretch fill-bg-color'>
            <div className='section-title'>
                <h1 className='bg-orange text-medium'>{it.L('{JAPAN ONLY}Why choose binary options over foreign exchange')}</h1>
            </div>
            <div className='container'>
                <h2 className='center-text color-blue text-medium'>{it.L('{JAPAN ONLY}A binary option can provide profit opportunities even in a small price range, where FX normally doesn’t. Here is a table comparison of foreign exchange and binary options:')}</h2>
                <div className='gr-row cards'>
        ...
        <section className='pattern pattern-confetti fill-bg-color'>
            <div className='section-title'>
                <h1 className='bg-orange text-semibold v-padding'>{it.L('{JAPAN ONLY}YOUR FUNDS ARE HELD SECURELY')}</h1>
            </div>
            <div  className='container'>
                <h2 className='color-blue text-semibold'>{it.L('{JAPAN ONLY}All customer funds are deposited with JSF Trust & Banking, and in the event of our business failure, they will be refunde via an independent attorney acting as beneficiary agent')}</h2>
                <div className='gr-row cards'>
                    <div className='gr-5 gr-push-1 gr-12-m gr-push-0-m'>
                        <div className='card--light'>
                            <div className='card-header__bubble'>
