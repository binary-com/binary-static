        ...
        <div className='invisible' id='set_currency'>
            <div className='center-text'>
                ...
                <div className='invisible' id='show_new_account'>
                    ...
                    <p>{it.L('You have successfully created your real money [_1]account.', `<span data-show="iom">${it.L('gaming')}&nbsp;</span>`)}</p>
                </div>
                ...
                <div className='invisible select_currency'>
                    <p>{it.L('Do you want this to be a fiat account or crypto account? Please choose one:')}</p>
                </div>
            </div>
