                            ...
                            <div id='mv_new_account'>
                                ...
                                <div id='view_2' className='gr-row invisible'>
                                    <div className='gr-8 gr-12-m'>
                                        ...
                                        <FormRow is_two_rows type='password' id='txt_investor_pass' label={it.L('Investor password (read-only access)')} tooltip={it.L('Investor password is used for limited access to your MT5 account in read-only mode.')} hint={it.L('Minimum eight characters. Must contain numbers, and mix of upper and lower case letters.')} />
                                        <SubmitButton
                                            no_wrapper
                                            type='submit'
