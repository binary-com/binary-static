            ...
            <div id='mt_account_management' className='gr-row invisible'>
                ...
                <div id='templates' className='invisible'>
                    ...
                    <div id='messages'>
                        ...
                        <div id='msg_proceed_authentication'>{it.L('Please [_1]authenticate your account[_2] before creating an MT5 account.', `<a href="${it.url_for('user/authenticate')}">`, '</a>')}</div>
