            ...
            <div className='gr-parent gr-padding-10' id='container_reset_password'>
                <form id='frm_reset_password'>
                    <Fieldset legend={it.L('Details')}>
                        <FormRow type='radio' id='have_real_account' options={ [{ value: 'yes', label: it.L('Yes') }, { value: 'no', label: L.it('No') }] } default_option={'no'} label={it.L('Do you have a real money account?')} />
