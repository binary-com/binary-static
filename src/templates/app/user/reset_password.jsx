            ...
            <div className='gr-parent gr-padding-10' id='container_reset_password'>
                <form id='frm_reset_password'>
                    <Fieldset legend={it.L('Details')}>
                        <FormRow type='radio' spaced id='have_real_account' options={ [{ value: 0, label: 'Yes' }, { value: 1, label: 'No' }] } default_option={1} label={it.L('Do you have a real money account?')} />
