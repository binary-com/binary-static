...
<div className='gr-12 static_full'>
    ...
    <form id='virtual-form' className='gr-padding-10'>
        <Fieldset legend={it.L('Details')} >
            <FormRow type='password' id='client_password' label={it.L('Choose a password')}
            ...
            <FormRow type='checkbox' defaultChecked id='email_consent' row_class='invisible' label_row_id='email_consent_label'
