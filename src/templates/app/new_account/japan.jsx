...
<div className='gr-12 static_full'>
    ...
    <form id='japan-form' className='gr-padding-10'>
        ...
        <Fieldset legend={it.L('Status')} >
            <FormRow type='checkbox' spaced={1} id='declare_not_fatca' label={it.L('Not FATCA*')}
            ...
            <FormRow type='text' id='daily_loss_limit' label={it.L('Daily limit on losses')}
        ...
        <Fieldset legend={it.L('Trading Experience')} >
            ...
            <FormRow type='text' row_class='hedging-assets invisible' id='hedge_asset_amount' label={it.L('Amount of above assets')} attributes={{maxLength: '20'}} />
        </Fieldset>
