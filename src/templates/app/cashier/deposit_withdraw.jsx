...
const DepositWithdraw = () => (
    <div id="deposit_withdraw">
        ...
        <div class="invisible">
            <div class="gr-padding-10 gr-parent invisible" id="message_bitcoin_cash">
                <div class="notice-msg center-text">
                    <div class="gr-padding-10">{it.L('Please note that you are currently using your [_1]Bitcoin Cash[_2] account. You can only fund your account in [_1]Bitcoin Cash[_2], and not Bitcoin.', '<a href="https://www.bitcoincash.org" target="_blank" rel="noopener noreferrer">', '</a>')}</div>
                </div>
            </div>
        ...
        <form id="frm_ukgc" class="gr-row gr-parent invisible">
            <div class="gr-2 gr-6-m gr-centered-m">
                <p><img class="responsive" src={it.url_for('images/pages/cashier/protection-icon.svg')} /></p>
            </div>
