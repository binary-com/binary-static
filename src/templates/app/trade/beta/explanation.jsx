    ...
    <div className='gr-12'>
        ...
        <div id='explanation_explain' className='invisible gr-padding-20 gr-child'>
            ...
            <div id='explain_endsinout' className='invisible'>
                ...
                <p>{it.L('The <strong>exit spot</strong> is the spot at the <strong>end time</strong>.')}</p>
                ...
                <p className='hint'><strong>{it.L('Note')}: </strong>{it.L('Ends In/Out contracts will be refunded at the purchase price if there are less than 2 ticks between the start and end times.')}</p>
            </div>
            ...
            <div id='explain_higherlower' className='invisible'>
                <h3>{it.L('Exit spot')}</h3>
                <p>{it.L('The <strong>exit spot</strong> is the spot at the <strong>end time</strong>.')}</p>
                <p>{it.L('The <strong>end time</strong> is the selected number of seconds/minutes/hours after the <strong>start time</strong> (if less than one day in duration), or at the end of the trading day (if one day or more in duration).')}</p>
                <p>{it.L('The <strong>start time</strong> is when the contract is processed by our servers.')}</p>
            ...
            <div id='explain_risefall' className='invisible'>
                ...
                <h3>{it.L('Exit spot')}</h3>
                <p>
                    {it.L('The <strong>exit spot</strong> is the spot at the <strong>end time</strong>.')}
                    <br />
            ...
            <div id='explain_staysinout' className='invisible'>
                ...
                <p>{it.L('The <strong>start time</strong> is when the contract is processed by our servers.')}</p>
                <p>{it.L('The <strong>end time</strong> is the selected number of minutes/hours after the <strong>start time</strong> (if less than one day in duration), or at the end of the trading day (if one day or more in duration).')}</p>
                <p className='hint'><strong>{it.L('Note')}: </strong>{it.L('Stays In/Goes Out Contracts will be refunded at the purchase price if there are less than 2 ticks between the start and end times.')}</p>
            </div>
