...
**[Template versus Sass:](#svg-template-versus-sass)** Add SVGs as components if you need to add classes to modify them in different themes. Otherwise you may import them in Sass.
