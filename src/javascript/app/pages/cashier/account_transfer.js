...
const AccountTransfer = (() => {
    ...
    const showForm = () => {
        ...
        FormManager.init(form_id_hash, [
            { selector: '#amount', validations: [['req', { hide_asterisk: true }], ['number', { type: 'float', decimals: Currency.getDecimalPlaces(client_currency), min: Currency.getMinWithdrawal(client_currency), max: Math.min(+withdrawal_limit, +client_balance), format_money: true }]] },
    ...
    const onLoad = () => {
        ...
        BinarySocket.wait('balance').then((response) => {
            ...
            const min_amount = Currency.getMinWithdrawal(client_currency);
