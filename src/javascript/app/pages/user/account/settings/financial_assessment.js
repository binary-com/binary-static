...
const FinancialAssessment = (() => {
    ...
    const handleForm = (response = State.getResponse('get_financial_assessment')) => {
        ...
        const is_mt5_financial = /labuan_advanced|real_svg_standard|real_vanuatu_advanced|real_vanuatu_mamm_advanced/.test(localStorage.getItem('financial_assessment_redirect'));
