...
const ViewPopup = (() => {
    ...
    const initAuditTable = (show) => {
        ...
        const th_previous = Utility.createElement('th', { class: 'gr-2 gr-3-t gr-3-p gr-6-m' });
        ...
        tr.appendChild(Utility.createElement('th', { class: 'gr-8 gr-6-t gr-6-p gr-5-m', text: localize('Audit Page') }));
        tr.appendChild(Utility.createElement('th', { class: 'gr-2 gr-3-t gr-3-p gr-1-m' }));
