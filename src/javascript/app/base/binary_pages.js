...
const PaymentAgentTransfer = require('../pages/user/account/payment_agent_transfer');
...
const IPHistory            = require('../pages/user/account/settings/iphistory');
const Limits               = require('../pages/user/account/settings/limits');
...
const GetStartedJP       = require('../../static/pages/get_started_jp');
const Home               = require('../../static/pages/home');
const HomeJP             = require('../../static/pages/home_jp');
