    ...
    const displayAccountStatus = () => {
        BinarySocket.wait('authorize').then(() => {
            ...
            const messages = {
                ...
                risk                 : () => buildMessage('Trading and deposits have been disabled on your account. Please complete the [_1]financial assessment form[_2] to resolve this issue.',                                   'user/settings/assessmentws'),
