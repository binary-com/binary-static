...
const ChartSettings = (() => {
    ...
    const setLabels = (params) => {
        labels = labels || { // needs to be inside setLabels function so localize works
            ...
            entry_exit_spot: `<div class='nowrap gr-padding-10 gr-parent'><span style="${common_vertical_line_style} border-color: #e98024; border-style: solid;"></span>${localize('Entry/Exit Spot')}&nbsp;</div>`,
        ...
        const start_time        = is_high_low_ticks ? labels.entry_exit_spot : labels.start_time;
