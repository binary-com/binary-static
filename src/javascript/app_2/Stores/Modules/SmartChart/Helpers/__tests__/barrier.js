...
describe('Barriers', () => {
    ...
    describe('barriersToString', () => {
        ...
        it('should convert zero barriers which do not have +/- to string consisting of them without +/-', () => {
            expect(barriersToString(false, [+11,15])).to.eql(['11,15']);
        });
        // it('should convert zero barriers which do not have +/- to string consisting of them with +/- while is_relative is true', () => {
