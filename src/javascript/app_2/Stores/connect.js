...
export const connect_v2 = (Store, mapStoresToProps, handleProps) => {
    class UnboxedComponent extends Component {
        ...
        render() {
            return React.createElement(this.injectedComponent, { className: this.props.className }, this.props.children);
        }
    }
