...
const TradingTimePicker = ({
    ...
    const moment_expiry_date       = toMoment(expiry_date || server_time);
    const moment_market_open_times = setTime(moment_expiry_date.clone(), market_open_times[0]);
    ...
    return (
        <TimePicker
            ...
            value={market_open_times[0] || min_date_expiry.format('HH:mm')}
        />
    );
};
