        ...
        switch (type) {
            ...
            case 'digiteven':
                IconType = (
                    <g fill='none' fillRule='evenodd'>
                        <path fill='#101320' d='M0 0h16v16H0z' />
                        <path fill='#F93' d='M.135 6.49V.158h6.333V6.49H.135zM4.26 2.39H2.366v1.893H4.26V2.389zM9.6 16V9.668h6.332V16H9.6zm4.101-4.124h-1.893v1.893h1.893v-1.893z' />
                        <path fill='#FFF' d='M9.6.158h6.332V6.49H9.6V.158zm2.208 4.124h1.893V2.389h-1.893v1.893zM.135 16V9.668h6.333V16H.135zm4.124-4.124H2.366v1.893H4.26v-1.893z' />
                    </g>
                );
                break;
            case 'digitmatch':
            ...
            case 'digitodd':
                IconType = (
                    <g fill='none' fillRule='evenodd'>
                        <path fill='#101320' d='M0 0h16v16H0z' />
                        <path d='M0 0h16v16H0z' />
                        <path fill='#F93' d='M11.628 7.827H4.237L7.91 2l3.718 5.827zM7.256 6.155h1.352l-.676-1.068-.676 1.068z' />
                        <path fill='#FFF' d='M7.46 14.86H.067L3.74 9.035l3.718 5.827zm-4.395-1.67h1.352L3.74 12.12l-.676 1.068zm12.755 1.67H8.428l3.673-5.826 3.719 5.827zm-4.372-1.67H12.8l-.676-1.069-.676 1.068z' />
                    </g>
                );
                break;
            case 'digitover':
