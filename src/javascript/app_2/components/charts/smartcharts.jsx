...
const SmartCharts = ({
    ...
    const barriers = Object.keys(chart_barriers || {}).map(key => toJS(chart_barriers[key])).filter(item => !isEmptyObject(item));
...
export default connect(
    ({ modules, ui }) => ({
        ...
        // chart_barriers: Object.keys(modules.trade.chart_barriers || {}).map(key => toJS(modules.trade.chart_barriers[key])),
