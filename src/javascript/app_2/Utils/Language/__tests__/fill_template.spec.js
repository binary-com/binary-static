...
describe('fillTemplate', () => {
    ...
    it('works for 1 tag at the start replaced with JSX', () => {
    ...
    it('works for 1 tag in the middle replaced with JSX', () => {
    ...
    it('works for 1 tag at the end replaced with JSX', () => {
    ...
    it('works for 2 tags replaced with JSX', () => {
        const img = <img src='images/avatar.jpg' />;
        expect(fillTemplate('[_1] think therefore [_1] am', { '1': img })).to.eql([img, ' think therefore ', img, ' am']);
    });
});
