    ...
    var display = function (details) {
        ...
        if (error) {
            ...
            brief.textContent = $('#underlying option:selected').text() + ' / ' +
                StringUtil.toTitleCase(Contract.contractType()[Contract.form()][purchase_data.echo_req.passthrough.contract_type]) +
                (Contract.form() === 'digits' ? ' ' + purchase_data.echo_req.passthrough.barrier : '');
