...
var indicative_mock_data = {9324828148: "4.33", 9299986648: "5.16"};
...
describe('Portfolio', function() {
    ...
    it('Should have balance', function() {
        var balance_data = portfolio.getBalance(balance);
        expect(balance_data).to.be.a('string');
    });
    ...
    it('Should calculate the correct indicative sum', function() {
        var indicative_sum_data = portfolio.getIndicativeSum(indicative_mock_data);
        var calculated_sum = parseFloat(indicative_mock_data[9324828148]) + parseFloat(indicative_mock_data[9299986648]);
    ...
    it('Should calculate the correct sum purchase', function() {
        var sum_purchase_data = portfolio.getSumPurchase();
        expect(sum_purchase_data).to.be.a('number')
            .and.to.eql(parseFloat(portfolio_mock_data.buy_price));
    });
});
