var ViewPopupWS = (function() {
    ...
    var normalUpdate = function() {
        var finalPrice      = contract.sell_price || contract.bid_price,
            ...
            indictive_price = finalPrice && is_ended ? (contract.sell_price || contract.bid_price) : contract.bid_price ? contract.bid_price : null;
        ...
        containerSetText('trade_details_indicative_price', indictive_price ? (contract.currency + ' ' + parseFloat(indictive_price).toFixed(2)) : '-');
