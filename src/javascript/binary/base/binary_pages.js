...
const pages_config = {
    ...
    knowledge_testws      : { module: KnowledgeTest,              is_authenticated: true },
    ...
    payment_agent_listws  : { module: PaymentAgentListWS,         is_authenticated: true },
    ...
    tnc_approvalws        : { module: TNCApproval,                is_authenticated: true },
